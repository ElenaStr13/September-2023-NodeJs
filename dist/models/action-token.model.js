...
const tokenSchema = new mongoose_1.default.Schema({
    ...
    tokenType: { type: String, required: true, enum: action_token_type_enum_1.ActionTokenTypeEnum },
    _userId: { type: mongoose_1.Types.ObjectId, required: true, ref: user_model_1.User },
}, {
    timestamps: true,
    versionKey: false,
});
exports.ActionToken = mongoose_1.default.model("action-tokens", tokenSchema);
