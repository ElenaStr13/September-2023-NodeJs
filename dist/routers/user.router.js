...
router.post("/me/avatar", auth_middleware_1.authMiddleware.checkAccessToken, file_middleware_1.fileMiddleware.isAvatarValid, user_controller_1.userController.uploadAvatar);
router.delete("/me/avatar", auth_middleware_1.authMiddleware.checkAccessToken, user_controller_1.userController.deleteAvatar);
