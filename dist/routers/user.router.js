...
router.put("/:userId", common_middleware_1.commonMiddleware.isBodyValid(user_validator_1.UserValidator.update), common_middleware_1.commonMiddleware.isIdValid, user_controller_1.userController.updateById);
