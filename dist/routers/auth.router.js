...
router.put("/forgot-password", common_middleware_1.commonMiddleware.isBodyValid(user_validator_1.UserValidator.setForgotPassword), auth_middleware_1.authMiddleware.checkActionToken, auth_controller_1.authController.setForgotPassword);
